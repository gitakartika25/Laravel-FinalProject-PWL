...
<body>
  ...
  <section id="topbar" class="d-none d-lg-flex align-items-center fixed-top topbar-transparent">
    <div class="container text-right">
      <i class="icofont-phone"></i> +62 292207416621
      <i class="icofont-clock-time icofont-rotate-180"></i> Mon-Sun: 12:00 AM - 23:00 PM
    </div>
  </section>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>Gitsa</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="book-a-table text-center"><a href="#book-a-table">Reservation</a></li>
          @guest
								<li class="nav-item">
    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(images/place1.jpg);">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background: url(images/places2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background: url(images/place3.jpg);">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box">
              ...
              <p>Dengan pemandangan yang menarik, membuat makanmu jadi asik!</p>
            </div>
          </div>
