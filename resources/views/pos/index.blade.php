@extends('layouts.apptransaction')
...
<div class="container-fluid">
                            ...
                            <div class="productCard">
                                <div class="view overlay">
                                    <form action="{{url('/transcation/addproduct', $product->id)}}" method="POST">
                                        ...
                                        @else
                                        <img class="card-img-top gambar" src="{{ $product->image }}"
                                            alt="Card image cap" style="cursor: pointer;width:100%;height:100%;"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            @can('admin-display')
                                ...
                                <option value="" holder>Other Customer...</option>@endcan
                                @can('user-display')
                                <option value="1">Reservasi</option>
        ...
        <div class="modal-dialog modal-full-height modal-right" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="qtyKursi">Qty Kursi</label>
                        <input id="qtyKursi" name="kursi" class="form-control" type="number">
                    </div>

                    <div class="form-group">
                        <label for="reservasi">DateTime Reservasi</label>
                        <input id="reservasi" name="date" class="form-control" type="date">
    ...
    <script>
        ...
        oke.oninput = function () {
            ...
            let kursi = parseInt(document.getElementById('qtyKursi').value) ? parseInt(document.getElementById('qtyKursi').value) : 0;
