...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark" style="background-color: black;padding-top:25px;padding-bottom:25px;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"href="{{ route('homeresto') }}" style="padding-right:25px;padding-left:25px;">Home</a>
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{ route('homeresto') }}">Home</a>
                            <a class="dropdown-item" href="/aboutresto">About</a>
                            <a class="dropdown-item" href="{{ route('menu')}}">Menu</a>
                        </div>
                    </li>@endcan
                    <li  class="nav-item"><a class="nav-link" href="" style="background-color:#ffb03b;border-radius:20px;padding-right:25px;padding-left:25px;">Reservation</a></li>
                    @can('admin-display')
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false" style="padding-right:25px;padding-left:25px;">Menu</a>
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                   ...
                   @endcan
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('/transcation/history')}}">History</a>
                    </li>
...
@endif
    ...
    <!-- Footer -->
        <footer class="page-footer " style="background-color: black;padding-top:25px;padding-bottom:25px;">
            <br>
          <!-- Footer Elements -->
          <div class="container">
