                    ...
                    <div class="row">
                        <div class="col-sm-6">
                              <table width="100%" class="table table-borderless">
                                ...
                                <tr>
                                    <td width="38%">Qty Kursi</td>
                                    <td width="2%">:</td>
                                    <td width="60%">{{$product->qtyKursi}}</td>
                                </tr>
                        ...
                        <div class="col-sm-6">
                            <table width="100%" class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td width="60%">Reservasi Online</td>
                                </tr>@endif  
                                <tr>
                                    <td width="38%">DateTime Reservasi</td>
                                    <td width="2%">:</td>
                                    <td width="60%">{{$product->tglReservasi}} {{$product->time}}</td>
                                </tr> 
